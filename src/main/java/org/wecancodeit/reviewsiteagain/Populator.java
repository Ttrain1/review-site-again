...
public class Populator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Game
		Review review4 = new Review("Link To The Past", "description", "8/10", "/link-to-the-past-cover.png",
				category2);
		Review review5 = new Review("Super Mario World",
				...
				"8/10", "/super-mario-world-cover.png", category2);
		Review review6 = new Review("Super Metroid",
